...
def levels_menu():
    ...
    back_levels_button = Button(Label('<', 100 * basics.FONT_COEFFICIENT, 'fonts/pixeboy_font.ttf', 'red', 'gray49', topleft=(10 * basics.X_COEFFICIENT, 10 * basics.Y_COEFFICIENT)), None, key=pygame.K_ESCAPE, feedbacks=[basics.CLICK_SOUND1.play, basics.LEVELS_MENU_MUSIC.stop, basics.PRELAST_RUN])
    levels_label = Label('LEVELS', 150 * basics.FONT_COEFFICIENT, 'fonts/endless_font.ttf', 'yellow', center=(basics.WIN_RECT.right / 2, 100 * basics.Y_COEFFICIENT))
    ...
    lvl1_icon_label = Label('Classic', 50 * basics.FONT_COEFFICIENT, 'fonts/tales_font.ttf', 'white', center=(320 * basics.X_COEFFICIENT, 472.5 * basics.Y_COEFFICIENT))
    ...
    lvl2_icon_label = Label('Ancient Egypt', 50 * basics.FONT_COEFFICIENT, 'fonts/tales_font.ttf', 'white', center=(720 * basics.X_COEFFICIENT, 472.5 * basics.Y_COEFFICIENT))
    ...
    lvl3_icon_label = Label('Middle Ages', 50 * basics.FONT_COEFFICIENT, 'fonts/tales_font.ttf', 'white', center=(1120 * basics.X_COEFFICIENT, 472.5 * basics.Y_COEFFICIENT))
    ...
    lvl4_icon_label = Label('Feudal Japan', 50 * basics.FONT_COEFFICIENT, 'fonts/tales_font.ttf', 'white', center=(520 * basics.X_COEFFICIENT, 747.5 * basics.Y_COEFFICIENT))
    ...
    interference = [pygame.transform.scale(pygame.image.load(f'objects/interference/{i}.jpeg'), (320 * basics.X_COEFFICIENT, 160 * basics.Y_COEFFICIENT)).convert() for i in range(5)]
    lock = pygame.transform.scale(pygame.image.load('objects/lock.png'), (50 * basics.X_COEFFICIENT, 75 * basics.Y_COEFFICIENT)).convert_alpha()
    ...
    while True:
        ...
        for level_icon in levels_icons:
            if len(basics.PASSED_LEVELS_LIST) >= levels_icons.index(level_icon):
                ...
                basics.WIN.blit(lock, (level_icon.content.rect.x + 135 * basics.X_COEFFICIENT, level_icon.content.rect.y + 37.5 * basics.Y_COEFFICIENT))
        pygame.event.pump()
