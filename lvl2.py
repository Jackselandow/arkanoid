...
def lvl2_main():
    ...
    basics.LEVEL.__init__(bg=Image('backgrounds/lvl2_bg.png', (basics.WIN_RECT.right, basics.WIN_RECT.bottom - basics.LEVEL.upper_menu.height), topleft=(0, basics.LEVEL.upper_menu.bottom)), music=basics.LVL2_MUSIC, platform=Platform((620 * basics.X_COEFFICIENT, 720 * basics.Y_COEFFICIENT), (200 * basics.X_COEFFICIENT, 30 * basics.Y_COEFFICIENT), 'objects/platform.png', 8))
