...
music = Music('sounds/lvl2_music.mp3', 1)
...
def run_lvl():
    ...
    level2_rect = level2_text.get_rect(center=(basics.WIN_RECT.right / 2, basics.upper_menu.bottom / 2))
    ...
    while run:
        ...
        WIN.blit(level2_text, level2_rect)
...
def lvl2_main():
    ...
    bg = pygame.transform.scale(pygame.image.load('backgrounds/lvl2_bg.png'), (basics.WIN_RECT.right, basics.WIN_RECT.bottom - basics.upper_menu.height))
