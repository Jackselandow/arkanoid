...
def run_lvl():
    ...
    level4_label = Label('l e v e l 4', 100 * basics.FONT_COEFFICIENT, 'fonts/retroblaze_font.ttf', basics.GREEN, center=(basics.WIN_RECT.right / 2, basics.LEVEL.upper_menu.bottom / 2))
    while True:
