...
def main_settings():
    ...
    back_settings_button = Button(Label('<', 100 * basics.FONT_COEFFICIENT, 'fonts/pixeboy_font.ttf', 'red', 'gray49', topleft=(10 * basics.X_COEFFICIENT, 10 * basics.Y_COEFFICIENT)), None, key=pygame.K_ESCAPE, feedbacks=[basics.CLICK_SOUND1.play, basics.SETTINGS_MUSIC.stop, basics.PRELAST_RUN])
    main_settings_label = Label('MAIN SETTINGS', 150 * basics.FONT_COEFFICIENT, 'fonts/endless_font.ttf', 'yellow', center=(basics.WIN_RECT.width / 2, 100 * basics.Y_COEFFICIENT))
    general_settings_button = Button(Label('GENERAL', 120 * basics.FONT_COEFFICIENT, 'fonts/pixeloid_font.ttf', 'white', topleft=(440 * basics.X_COEFFICIENT, 200 * basics.Y_COEFFICIENT)), None, 'arrows', 'white', feedbacks=[basics.CLICK_SOUND1.play, general_settings])
    volume_settings_button = Button(Label('VOLUME', 120 * basics.FONT_COEFFICIENT, 'fonts/pixeloid_font.ttf', 'white', topleft=(480 * basics.X_COEFFICIENT, 400 * basics.Y_COEFFICIENT)), None, 'arrows', 'white', feedbacks=[basics.CLICK_SOUND1.play, volume_settings])
    ball_shape_settings_button = Button(Label('BALL SHAPE', 120 * basics.FONT_COEFFICIENT, 'fonts/pixeloid_font.ttf', 'white', topleft=(310 * basics.X_COEFFICIENT, 600 * basics.Y_COEFFICIENT)), None, 'arrows', 'white', feedbacks=[basics.CLICK_SOUND1.play, ball_shape_settings])
    while True:
...
def general_settings():
    settings_bg = Image('backgrounds/settings_bg.jpg', (basics.WIN_RECT.right, basics.WIN_RECT.bottom), topleft=(0, 0))
    back_general_settings_button = Button(Label('<', 100 * basics.FONT_COEFFICIENT, 'fonts/pixeboy_font.ttf', 'red', 'gray49', topleft=(10 * basics.X_COEFFICIENT, 10 * basics.Y_COEFFICIENT)), None, key=pygame.K_ESCAPE, feedbacks=[basics.CLICK_SOUND1.play, basics.LAST_RUN])
    general_settings_label = Label('GENERAL SETTINGS', 100 * basics.FONT_COEFFICIENT, 'fonts/endless_font.ttf', 'yellow', center=(basics.WIN_RECT.right / 2, 75 * basics.Y_COEFFICIENT))
    control_type_label = Label('CONTROL TYPE', 50 * basics.FONT_COEFFICIENT, 'fonts/pixeloid_font.ttf', 'white', center=(basics.WIN_RECT.width / 2, 175 * basics.Y_COEFFICIENT))
    ...
    select_circle = pygame.transform.scale(pygame.image.load('objects/select_circle.png'), (50 * basics.X_COEFFICIENT, 50 * basics.Y_COEFFICIENT)).convert_alpha()
    select_dot = pygame.transform.scale(pygame.image.load('objects/select_dot.png'), (50 * basics.X_COEFFICIENT, 50 * basics.Y_COEFFICIENT)).convert_alpha()
    shape_animation_label = Label('BALL SHAPE ANIMATION', 50 * basics.FONT_COEFFICIENT, 'fonts/pixeloid_font.ttf', 'white', center=(basics.WIN_RECT.width / 2, 525 * basics.Y_COEFFICIENT))
...
def volume_settings():
    settings_bg = Image('backgrounds/settings_bg.jpg', (basics.WIN_RECT.right, basics.WIN_RECT.bottom), topleft=(0, 0))
    back_volume_settings_button = Button(Label('<', 100 * basics.FONT_COEFFICIENT, 'fonts/pixeboy_font.ttf', 'red', 'gray49', topleft=(10 * basics.X_COEFFICIENT, 10 * basics.Y_COEFFICIENT)), None, key=pygame.K_ESCAPE)
    volume_settings_label = Label('VOLUME SETTINGS', 100 * basics.FONT_COEFFICIENT, 'fonts/endless_font.ttf', 'yellow', center=(basics.WIN_RECT.right / 2, 75 * basics.Y_COEFFICIENT))
    general_volume_label = Label('GENERAL VOLUME', 50 * basics.FONT_COEFFICIENT, 'fonts/pixeloid_font.ttf', 'white', center=(basics.WIN_RECT.right / 2, 175 * basics.Y_COEFFICIENT))
    music_volume_label = Label('MUSIC VOLUME', 50 * basics.FONT_COEFFICIENT, 'fonts/pixeloid_font.ttf', 'white', center=(basics.WIN_RECT.right / 2, 400 * basics.Y_COEFFICIENT))
    sound_volume_label = Label('SOUND VOLUME', 50 * basics.FONT_COEFFICIENT, 'fonts/pixeloid_font.ttf', 'white', center=(basics.WIN_RECT.right / 2, 625 * basics.Y_COEFFICIENT))
    volume_bar = pygame.transform.scale(pygame.image.load('objects/volume_bar.png'), (680 * basics.X_COEFFICIENT, 110 * basics.Y_COEFFICIENT)).convert_alpha()
    ...
    while True:
        ...
        for i in range(int(basics.VOLUME * 10)):
            pygame.draw.rect(basics.WIN, 'red', pygame.Rect(general_volume_square_x * basics.X_COEFFICIENT, 230 * basics.Y_COEFFICIENT, 50 * basics.X_COEFFICIENT, 50 * basics.Y_COEFFICIENT))
            general_volume_square_x += 63
        for i in range(int(basics.MUSIC_VOLUME * 10)):
            pygame.draw.rect(basics.WIN, 'red', pygame.Rect(music_volume_square_x * basics.X_COEFFICIENT, 455 * basics.Y_COEFFICIENT, 50 * basics.X_COEFFICIENT, 50 * basics.Y_COEFFICIENT))
            music_volume_square_x += 63
        for i in range(int(basics.SOUND_VOLUME * 10)):
            pygame.draw.rect(basics.WIN, 'red', pygame.Rect(sound_volume_square_x * basics.X_COEFFICIENT, 680 * basics.Y_COEFFICIENT, 50 * basics.X_COEFFICIENT, 50 * basics.Y_COEFFICIENT))
...
def ball_shape_settings():
    ...
    shape_name_label = Label(shape.name, 75 * basics.FONT_COEFFICIENT, 'fonts/endless_font.ttf', 'green', center=(basics.WIN_RECT.right / 2, 400 * basics.Y_COEFFICIENT))
    description_label = Label('Description:', 50 * basics.FONT_COEFFICIENT, 'fonts/tales_font.ttf', 'orange', topleft=(50 * basics.X_COEFFICIENT, 450 * basics.Y_COEFFICIENT))
    shape_description_label = Label(shape.description, 50 * basics.FONT_COEFFICIENT, 'fonts/tales_font.ttf', 'orange', topleft=(50 * basics.X_COEFFICIENT, 520 * basics.Y_COEFFICIENT))

    settings_bg = Image('backgrounds/settings_bg.jpg', (basics.WIN_RECT.right, basics.WIN_RECT.bottom), topleft=(0, 0))
    back_ball_shape_settings_button = Button(Label('<', 100 * basics.FONT_COEFFICIENT, 'fonts/pixeboy_font.ttf', 'red', 'gray49', topleft=(10 * basics.X_COEFFICIENT, 10 * basics.Y_COEFFICIENT)), None, key=pygame.K_ESCAPE, feedbacks=[basics.CLICK_SOUND1.play, basics.LAST_RUN])
    ball_shape_settings_label = Label('BALL SHAPE', 100 * basics.FONT_COEFFICIENT, 'fonts/endless_font.ttf', 'yellow', center=(basics.WIN_RECT.right / 2, 75 * basics.Y_COEFFICIENT))
    previous_shape_button = Button(Label('<', 200 * basics.FONT_COEFFICIENT, 'fonts/pixeboy_font.ttf', 'red', topleft=(496 * basics.X_COEFFICIENT, 193 * basics.Y_COEFFICIENT)), None, key=pygame.K_LEFT)
    next_shape_button = Button(Label('>', 200 * basics.FONT_COEFFICIENT, 'fonts/pixeboy_font.ttf', 'red', topleft=(850 * basics.X_COEFFICIENT, 193 * basics.Y_COEFFICIENT)), None, key=pygame.K_RIGHT)
    confirm_shape_button = Button(Label('CONFIRM', 100 * basics.FONT_COEFFICIENT, 'fonts/pixeloid_font.ttf', 'white', 'red', topleft=(485.5 * basics.X_COEFFICIENT, 650 * basics.Y_COEFFICIENT)), None, key=pygame.K_SPACE)
    while True:
        basics.CLOCK.tick(basics.FPS)
        settings_bg.show()
