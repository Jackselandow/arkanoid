...
def run_lvl():
    ...
    level1_label = Label('l e v e l 1', 100 * basics.FONT_COEFFICIENT, 'fonts/retroblaze_font.ttf', basics.GREEN, center=(basics.WIN_RECT.right / 2, basics.LEVEL.upper_menu.bottom / 2))
    while True:
        bricks_left_label = Label('BRICKS LEFT: ' + str(len(basics.LEVEL.bricks_group)), 60 * basics.FONT_COEFFICIENT, 'fonts/pixeboy_font.ttf', basics.WHITE, bottomright=(basics.WIN_RECT.right - 8 * basics.X_COEFFICIENT, basics.LEVEL.upper_menu.bottom - 8 * basics.Y_COEFFICIENT))
